...
require_deploy("docker image prune -f", "deploy must prune dangling images after startup")
...
require("scripts/compose-observability-diagnostics.sh", "observability diagnostics wrapper must be staged")
require_deploy('scripts/test-observability-smoke.sh', "deploy must require the observability smoke script")
require_deploy('scripts/compose-observability-diagnostics.sh', "deploy must require the observability diagnostics wrapper")
