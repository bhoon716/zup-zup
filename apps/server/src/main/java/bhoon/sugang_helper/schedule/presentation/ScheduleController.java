...
public class ScheduleController {
    ...
    @GetMapping
    public ResponseEntity<CommonResponse<List<ScheduleResponse>>> getUpcomingSchedules() {
        return CommonResponse.ok(scheduleService.getUpcomingSchedules(), "예정된 주요 일정 목록입니다.");
    }
}
