...
public class SecurityConstant {
    ...
    public static final String SESSION_AUTHENTICATION_EXPIRES_AT = "AUTHENTICATION_EXPIRES_AT";
    public static final String SESSION_AUTHENTICATION_USER_ID = "AUTHENTICATION_USER_ID";
