      ...
      <main className="max-w-[1600px] mx-auto p-6 md:p-10 lg:p-12">
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          >
            ...
            <div className="bg-white rounded-[2rem] shadow-card border border-slate-100 p-6 sm:p-8 min-h-[600px] flex flex-col transition-all hover:shadow-lg">
          ...
          <motion.aside 
            ...
            className="w-full lg:w-96 shrink-0 flex flex-col gap-6 lg:sticky lg:top-24"
          >
            <SubscriptionList />
          </motion.aside>
        </div>
