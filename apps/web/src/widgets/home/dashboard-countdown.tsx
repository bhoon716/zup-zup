...
export function DashboardCountdown({
  ...
  return (
    <motion.div
      ...
      className="flex items-center gap-1.5 sm:gap-2 bg-primary/10 border border-primary/30 rounded-xl px-2.5 sm:px-3 h-8 sm:h-9 select-none shrink-0"
    >
      <CalendarDays className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-primary shrink-0" />
      <span className="text-[10px] sm:text-xs font-black text-primary tracking-tight whitespace-nowrap">
